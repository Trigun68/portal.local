 ...
 * @link http://phpfaq.ru/Connection_DB
 *
 ...
 * Connection:
 *
 * $db = new Connection_DB(); // with default settings
 *
 * $opts = array(
 *		'user'    => 'user',
 *		'pass'    => 'pass',
 ...
 *		'charset' => 'latin1'
 * );
 * $db = new Connection_DB($opts); // with some of the default settings overwritten
 *
 ...
 *
 * $db = new Connection_DB(['mysqli' => $mysqli]);
 *
 * Some examples:
 *
